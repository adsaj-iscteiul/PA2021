    ...
    override fun visit(obj: JSON_Object) {
        ...
        while (objectFields < obj.objectMap.size) {
            ...
            if (objectFields == obj.objectMap.size - 1) {
                ...
                serializedValue += obj.spacing + JSON_Whitespace.HorizontalTab.whitespace + obj.objectMap.keys.elementAt(objectFields).serialize() + JSON_Whitespace.Space.whitespace +
                        ":" + JSON_Whitespace.Space.whitespace + obj.objectMap.values.elementAt(objectFields).serialize() + JSON_Whitespace.Linefeed.whitespace
